...
興味分野:<br>
最近はスパース推定やグラフィカルモデルを中心に新手法の開発を狙ってます． <br>Bioinformatics(主に分子進化や微生物学、アストロバイオ)が好き．<br><br>

使用言語: Pythonが得意, Bash, R, JavaScript, SQLも一応出来る．<br>
労働経験: ITベンチャー、大手金融・FXでクオンツのインターン経験あり．<br><br>
論文: <br>
